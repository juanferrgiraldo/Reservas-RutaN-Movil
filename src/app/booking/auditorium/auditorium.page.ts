...
@Component({
  ...
  templateUrl: './auditorium.page.html',
  styleUrls: ['./auditorium.page.scss'],
})
export class AuditoriumPage implements OnInit {
  ...
  constructor(private bookingService: BookingService, private router: Router,
    private auditoriumService: AuditoriumService, private formBuilder: FormBuilder) {
    if (this.auditoriumService.getTransferComponent() === null ||
      this.auditoriumService.getTransferComponent() === undefined) {
      this.router.navigate(['/mapa/torrea']);
      return;
    }
    this.roomInfo = this.auditoriumService.getTransferComponent();
  ...
  clearData() {
    ...
    this.booking.placeKind = 'auditorium';
    this.booking.initdate = null;
    this.booking.finishdate = null;
